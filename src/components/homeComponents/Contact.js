...
function Contact() {
    return (
        <div className="px-[5vw] mb-[3vh] items-center flex flex-col sm:block">
        ...
        <div className="flex gap-2 items-center">
          <span>
            ...
            <a href="mailto:cadienlake@gmail.com">
              <Mail className="hover:fill-blue-500 hover:rotate-12" />
            </a>
          </span>
          <span>
            <a href="https://github.com/cadienlake">
              <GitHub className="hover:fill-blue-500 hover:rotate-12" />
            </a>
          </span>
          <span>
            <a href="https://www.instagram.com/cadienlakejames/">
              <Instagram className="hover:fill-blue-500 hover:rotate-12" />
            </a>
          </span>
        </div>
      </div> 
